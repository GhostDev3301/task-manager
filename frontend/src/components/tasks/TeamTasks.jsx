...
import { useState, useEffect } from 'react';
import { getTeamTasks, getTeamMembers, createTeamTask, deleteTeamTask, updateTeamTaskStatus } from '../../mocks/teamMock';
import { format } from 'date-fns';
...
const TeamTasks = () => {
  ...
  const handleDelete = async (taskId) => {
    const confirm = window.confirm('¿Estás seguro de que deseas eliminar esta tarea grupal?');
    if (!confirm) return;
    try {
